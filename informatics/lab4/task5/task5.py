with open("informatics/lab4/task1/task1.py", "r") as file:
    code = file.read()
    exec(code)
...
# Измерение времени выполнения для file1.py
...
# Измерение времени выполнения для file2.py
...
# Измерение времени выполнения для file3.py
...
# Измерение времени выполнения для file4.py
